<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="add_voter.php">Voters</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="view_candidates.php">Candidates</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="view_casted_votes.php">View Casted Votes</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="add_winner.php">Result</a>
      </li>
      <li class="nav-item">
